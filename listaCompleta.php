                            ...
                            <div class="card border-left-danger shadow ">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm" id="dataTableOrden" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Folio</th>
                                                    <th>Cliente</th>
                                                ...
                                                while ($Orden = mysqli_fetch_array($rsOrden)) {
                                                    ...
                                                    <td>";
                                                        ...
                                                        if ($_SESSION['priv_user'] == 1) {
                                                            echo "
                                                        <form id='cleanForm' action='assets/controler/reportes/reporteArchivo.php' method='POST' target='_blank'>   
                                                            ...
                                                            <input type='hidden' class='form-control' name='reporte' value=" . $Orden['id_orden'] . ">
                                                            <button type='submit' class='btn btn-outline-light text-dark btn-sm BtnArchivo'>
                    ...
                    <form class='form' action='assets/controler/reportes/reporteOrdenes.php' method='POST' target="_blank">
                        ...
                        <div class='row'>
                            ...
                            <div class='col-lg-4 col-md-4 col-sm-12 col-xs-12'>
                                ...
                                <div class='input-group '>
                                    ...
                                    <input type='checkbox' checked data-toggle='toggle' data-width='240' name='correo' data-onstyle='outline-danger' data-offstyle='outline-secondary' data-on="<i class='fas fa-check'></i> Enviar" data-off="<i class='fas fa-times'></i> No Enviar">
                                </div>
                            </div>
                        ...
                        <div class='row'>
                            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                                <button type='submit' class='btn btn-outline-danger btn-block' onClick="refresh()"><i class='fas fa-file-pdf'></i>
                                    Generar PDF</button>
                            </div>
                        </div>
