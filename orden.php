                        ...
                        <div class="col-xl-12 col-md-12 mb-12">
                            <div class="card border-left-danger shadow ">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form class="form" id="cleanFormOrden" action="assets/controler/orden/altaOrden.php" method="POST">
                                        <div class="row">
                                            <!-- form cliente -->
                                            <div class="col-12">
                                                <fieldset class='border p-2'>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-2 col-md-6 col-sm-4 col-lg-2">
                                                            <label>Nuevo:</label>
                                                            <button type="button" class="btn btn-outline-secondary btn-block" data-toggle="modal" data-target="#modalCliente"><i class="fas fa-user-plus"></i>
                                                                Agregar</button>
                                                        </div>
                                                        <!--Campo Cliente -->
                                                        <div class="col-xl-10 col-md-6 col-sm-8 col-lg-10">
                                                            ...
                                                            <div class="input-group ">
                                                                ...
                                                                <select name="fromOrdCli" class="mi-selector custom-select" required>
                                                                    <option value="" selected disabled>Seleccione datos del cliente</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-4 col-md-6 col-sm-6 col-lg-4">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <select name="fromOrdSer" class="custom-select" required>
                                                            ...
                                                            <div class="col-xl-4 col-md-6 col-sm-6 col-lg-4">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="date" class="form-control" placeholder="Fecha de remision" value="<?php echo date('Y-m-d', strtotime("now")); ?>" name="forOrdFec" readonly required>
                                                                </div>
                                                            </div>
                                                            <!--Campo Herramienta -->
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col">
                                                        <button type="button" onClick="cleanOrden();" class="btn btn-outline-secondary btn-block"><i class="fas fa-eraser"></i>
                                                            Borrar</button>
                                                    </div>
                                                    <div class="col">
                                                        <button type="submit" class="btn btn-outline-danger btn-block"><i class="fas fa-paper-plane"></i>
                                                            Enviar</button>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-left-danger shadow ">
                ...
                <div class="modal-body">
                    <form class="form" id="cleanFormCliente" action="assets/controler/cliente/altaCliModal.php" method="POST">
                        <!-- form cliente -->
                        <fieldset class='border p-2'>
                            <legend class='w-auto'>Datos del Cliente:</legend>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Municipio" name="formCliMun" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="tel" class="form-control" placeholder="Teléfono cliente" name="formCliTel" required>
                                    </div>
                                </div>
