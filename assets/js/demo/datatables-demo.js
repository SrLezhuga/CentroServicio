...
$(document).ready(function() {
    $('#dataTableHerramienta').DataTable({
        "language": {
            "sProcessing": "Procesando...",
            "sLengthMenu": "Mostrar _MENU_ herramientas",
            "sZeroRecords": "No se encontraron resultados",
            "sEmptyTable": "Ningún dato disponible en esta tabla",
            "sInfo": "Mostrando  _START_ a _END_ herramientas de un total de _TOTAL_ herramientas",
            "sInfoEmpty": "Sin inventario que mostrar",
            "sInfoFiltered": "(filtrado de un total de _MAX_ herramientas)",
            "sInfoPostFix": "",
            "sSearch": "Buscar:",
            "sUrl": "",
            "sInfoThousands": ",",
...
$(document).ready(function() {
    $('#dataTableCliente').DataTable({
        "language": {
            ...
            "sZeroRecords": "No se encontraron resultados",
            "sEmptyTable": "Ningún dato disponible en esta tabla",
            "sInfo": "Mostrando  _START_ a _END_ clientes de un total de _TOTAL_ clientes",
            "sInfoEmpty": "Sin clientes que mostrar",
...
$(document).ready(function() {
    $('#dataTableRefacciones').DataTable({
        "language": {
            "sProcessing": "Procesando...",
            "sLengthMenu": "Mostrar _MENU_ Refacciones",
            "sZeroRecords": "No se encontraron resultados",
            "sEmptyTable": "Sin refacciones usadas",
            "sInfo": "Mostrando  _START_ a _END_ Refacciones de un total de _TOTAL_ Refacciones",
            "sInfoEmpty": "Sin Refacciones que mostrar",
            "sInfoFiltered": "(filtrado de un total de _MAX_ Refacciones)",
            "sInfoPostFix": "",
            "sSearch": "Buscar:",
            "sUrl": "",
            "sInfoThousands": ",",
...
$(document).ready(function() {
    $('#dataTableMarcas').DataTable({
        "language": {
            ...
            "sZeroRecords": "No se encontraron resultados",
            "sEmptyTable": "Sin Marcas usados",
            "sInfo": "Mostrando  _START_ a _END_ Marcas de un total de _TOTAL_ Marcas",
            "sInfoEmpty": "Sin Marcas que mostrar",
...
$(document).ready(function() {
    $('#dataTableSucursales').DataTable({
        "language": {
            "sProcessing": "Procesando...",
            "sLengthMenu": "Mostrar _MENU_ Sucursales",
            "sZeroRecords": "No se encontraron resultados",
            "sEmptyTable": "Sin Sucursales usados",
            "sInfo": "Mostrando  _START_ a _END_ Sucursales de un total de _TOTAL_ Sucursales",
            "sInfoEmpty": "Sin Sucursales que mostrar",
