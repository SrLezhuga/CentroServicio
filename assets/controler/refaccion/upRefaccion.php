<?php
 ...
 $listRef = "SELECT * FROM tab_refaccion WHERE cod_refaccion = '".$Refaccion."'"; 
    ...
    $itemRef = mysqli_fetch_array($rsRef);
     ...
     echo  $listDown = "DELETE FROM tab_ordenrefaccion WHERE cod_refaccion = '$Refaccion' AND id_orden = $Orden LIMIT 1";
