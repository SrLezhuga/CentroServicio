...
$queryCliente = "SELECT nom_cliente, mail_cliente FROM tab_cliente WHERE id_cliente =".$Pdf['id_cliente'];
            ...
            <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
                ...
                <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
                    ...
                    <div class='input-group '>
                        ...
                        <input type='text' class='form-control' placeholder='Correo cliente' name='mail' value='".$correo."' required>
                    </div>
                </div>
        </div>
