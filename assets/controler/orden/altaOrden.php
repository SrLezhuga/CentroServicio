...
('', '$clienteDatos', '$ordenUser', '$ordenFecha', '', 'EN ESPERA', DEFAULT, '$ordenHerramienta', '$ordenMarca', '$ordenModelo', '$ordenAdicional', '$ordenServicio', '$ordenDetalles',  'Sin Asignar', 'Sin Asignar', 'Sin Asignar')";
