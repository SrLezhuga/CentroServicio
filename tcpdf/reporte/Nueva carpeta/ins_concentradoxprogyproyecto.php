...
$obj=new conect;
  ...
  if(isset($_SESSION['usuario'])and $_SESSION['estado'] == 'autenticado' and $_SESSION['tipo_usuario']=='1')
  {
          ...
          $sqlString="SELECT DISTINCT * FROM  `_vw_reporte_concxprogramayproyectoinst`  where id_periodo='$periodo' order by id_proyecto";
...
$pdf->SetTitle('Reporte por Programa Y Proyecto Institucional');
