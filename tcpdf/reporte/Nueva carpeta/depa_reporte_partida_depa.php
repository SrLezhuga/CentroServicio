...
$obj=new conect;
  ...
  if(isset($_SESSION['usuario'])and $_SESSION['estado'] == 'autenticado')
  {
     ...
     $var="SELECT *from (select @id_depapartida := '$depa' i)alias,_vw_partida_depa where id_periodo='$periodo' order by id_capitulo,id_partida";
      $res=mysql_query($var);
...
$pdf->SetTitle('Reporte por Partida DEpartamental');
