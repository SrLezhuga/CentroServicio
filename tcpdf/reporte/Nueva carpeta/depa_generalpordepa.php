...
$pdf->SetTitle('Reporte General Departamental');
...
$pdf->SetFont('helvetica', 'I', 5);
 ...
 $sqlString="SELECT *from (select @prmid_departamento := '$depa' i)alias,_vw_reporte_institucional_depa where id_periodo='$periodo'  order by id_programa,id_proyecto,id_indicador_proyecto";
	$res=mysql_query($sqlString);
			//echo mysql_num_rows($res)."registros";
